...
if(checksubmit()) {
	$dat = array(
    	...
    	'switch_sys' => $_GPC['switch_sys'],	//微擎支付开关
		...
		//系统支付开关
		'sys_wxpay' => $_GPC['sys_wxpay'],			//微擎微信支付
		'sys_alipay' => $_GPC['sys_alipay'],		//微擎支付宝支付
		'sys_ylpay' => $_GPC['sys_ylpay'],			//微擎银联支付
		'sys_bdpay' => $_GPC['sys_bdpay'],			//微擎百度钱包支付
