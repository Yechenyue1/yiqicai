...
function getdataFrames(){
	...
	$frames['data']['items']['order_data']['active'] = '';
        ...
        $frames['data']['items']['all_data']['url'] = web_url('record/statistics');
	$frames['data']['items']['all_data']['title'] = '全部统计';
	$frames['data']['items']['all_data']['actions'] = array('op','statistics');
	$frames['data']['items']['all_data']['active'] = '';
...
function getsysFrames(){
	...
	$frames['sys']['items']['auth']['url'] = web_url('auth/display');
	$frames['sys']['items']['auth']['title'] = '系统授权';
	$frames['sys']['items']['auth']['actions'] = array('op','display');
	$frames['sys']['items']['auth']['active'] = '';
	
	$frames['sys']['items']['upgrade']['url'] = web_url('auth/upgrade');
	$frames['sys']['items']['upgrade']['title'] = '系统更新';
	$frames['sys']['items']['upgrade']['actions'] = array('op','upgrade');
	$frames['sys']['items']['upgrade']['active'] = '';
...
function get_top_menus(){
	...
	if($_W['isfounder']){
		$frames['sys']['title'] = '<i class="fa fa-cloud"></i>&nbsp;&nbsp; 云服务';
		$frames['sys']['url'] = web_url('auth/display');
		$frames['sys']['active'] = 'sys';
	}
